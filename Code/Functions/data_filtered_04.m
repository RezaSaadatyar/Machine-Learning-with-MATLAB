...
function [DataFilter, fss, FVal, Fstr, SW, SS] = data_filtered_04(Data, Input, fs, fl, fh, rp, rs, order, design, response, ...
...
if find(DataFilter) ~= 0
    plot_filter_05(Data, Input, DataFilter, VSInput, VInput, SInput, Vchi, Vchj, X, f, ax1, ax13, cm, CM, cmm);
end
end