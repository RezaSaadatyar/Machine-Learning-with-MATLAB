...
'Times New Roman','BackgroundColor',[0.65 0.65 0.65], 'ForegroundColor','b');
...
'Tooltip','Order>0');
S.t1=uicontrol('parent',S.L2,'style','text','string','Fpass (Hz):','unit',...
...
S.t1=uicontrol('parent',S.L2,'style','text','string','Fstop (Hz):',...
...
[0.005 0.41 0.39 0.55],'ShadowColor','b','Fontweight','bold','FontSize',12,'FontName',...
...
'outerposition',[0.4 0.6 0.6 0.4],'ShadowColor','m','Fontweight','bold','FontSize',...
...
'ShadowColor','g','Fontweight','bold','FontSize',12,'FontName','Times New Roman','BorderWidth',2);
...
tab4 = uitab(tabgp,'Title','<html><font name="Times New Roman" size=4 color="red"><b>De-noise</font></html>');
...
'Times New Roman','BackgroundColor',[0.65 0.65 0.65],'ForegroundColor','k');
S.L1=uipanel('parent',tab1,'Title','Classification & Clustring','unit','norm',...
'Position',[0.005 0.004 0.48 0.96],'ShadowColor',[0.49 0 0.6],'Fontweight','bold',...
...
[str,FF,Data,values] = load_data_01(handles.Lals,handles.inp,handles.text1,list);end
...
TPerf,TPe,TPer,FTP,TPerfT,FTPerf] = clear_parameters_02(S,list,Nfeat1,Nfeat2);end
function Inp_Callback(~, ~, handles)
[Inputch,DataFilter] = select_input_03(Data,handles.input,handles.inp,str,values,list,handles.radio,FF);end
function Input_Callback(~,~,handles)
[Input, FVal, Fstr, SW, SS] = select_channels_04(Inputch,handles.Chi,handles.Chj,handles.input,handles.inp,...
handles.display,handles.inputf,handles.list2,handles.inputw,handles.inputCC);end
%% ======================================== Step 2 =============================================
function Design_Callback(~, ~, handles)
[DataFilter,fs,FVal,Fstr,SW,SS] = data_filtered_04(Data,Input,handles.fs,handles.fl,handles.fh,handles.rp,...
