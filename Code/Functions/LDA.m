...
ylabel(p(1),{'Predict Classes in'; 'each Kfold (LDA)'});xlabel(p(1),'Sample');p(1).YTick=1:nclass;
...
til=legend(p(3),Kf,'Location','best');ylabel(p(3),{'Predict Classes in'; 'each Kfold (LDA)'});
